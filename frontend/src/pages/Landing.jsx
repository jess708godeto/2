      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center p-8 mt-12 mb-20">
        ...
        <div className="max-w-3xl mx-auto glass-panel p-8 rounded-3xl border border-white/10 mb-12 shadow-2xl relative overflow-hidden">
          ...
          <p className="text-lg text-gray-300 leading-relaxed">
            Somos un equipo de estudiantes que desarrolla la plataforma NeoUA enfocada en mejorar el aprendizaje digital. Buscamos ofrecer una experiencia educativa más accesible, personalizada y efectiva para todos.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-surface/50 p-8 rounded-2xl border border-white/5 relative">
              ...
              <p className="text-gray-300 mb-6 italic">"La forma en que esta plataforma integra la inteligencia artificial para personalizar el aprendizaje corporativo es el verdadero futuro de la educación profesional."</p>
